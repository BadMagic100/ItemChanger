...
public static class LifecycleEvents
{
    ...
    /// </summary>
    public static event Action OnItemChangerHook { add => onItemChangerHookSubscribers.Add(value); remove => onItemChangerHookSubscribers.Remove(value); }
    ...
    /// </summary>
    public static event Action OnItemChangerUnhook { add => onItemChangerUnhookSubscribers.Add(value); remove => onItemChangerUnhookSubscribers.Remove(value); }
    ...
    /// </summary>
    public static event Action BeforeStartNewGame { add => beforeStartNewGameSubscribers.Add(value); remove => beforeStartNewGameSubscribers.Remove(value); }
    ...
    /// </summary>
    public static event Action AfterStartNewGame { add => afterStartNewGameSubscribers.Add(value); remove => afterStartNewGameSubscribers.Remove(value); }
    ...
    /// </summary>
    public static event Action BeforeContinueGame { add => beforeContinueGameSubscribers.Add(value); remove => beforeContinueGameSubscribers.Remove(value); }
    ...
    /// </summary>
    public static event Action AfterContinueGame { add => afterContinueGameSubscribers.Add(value); remove => afterContinueGameSubscribers.Remove(value); }
    ...
    /// </summary>
    public static event Action OnEnterGame { add => onEnterGameSubscribers.Add(value); remove => onEnterGameSubscribers.Remove(value); }
    ...
    /// </remarks>
    public static event Action OnSafeToGiveItems { add => onSafeToGiveItemsSubscribers.Add(value); remove => onSafeToGiveItemsSubscribers.Remove(value); }
    ...
    /// </summary>
    public static event Action? OnLeaveGame { add => onLeaveGameSubscribers.Add(value); remove => onLeaveGameSubscribers.Remove(value); }
    private static readonly List<Action> onLeaveGameSubscribers = [];

    /// <summary>
    /// Used by the active <see cref="Internal.IItemChangerHost"/> to wire up lifecycle events.
    ...
    public class Invoker
    {
        ...
        public void NotifyBeforeStartNewGame() => InvokeHelper.InvokeList(beforeStartNewGameSubscribers);

        public void NotifyAfterStartNewGame() => InvokeHelper.InvokeList(afterStartNewGameSubscribers);

        public void NotifyBeforeContinueGame() => InvokeHelper.InvokeList(beforeContinueGameSubscribers);

        public void NotifyAfterContinueGame() => InvokeHelper.InvokeList(afterContinueGameSubscribers);

        public void NotifyOnEnterGame() => InvokeHelper.InvokeList(onEnterGameSubscribers);

        public void NotifyOnSafeToGiveItems() => InvokeHelper.InvokeList(onSafeToGiveItemsSubscribers);
